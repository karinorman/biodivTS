...
sample_occurrence <- map_dfr(unique(biotime_traits$plot_id), get_plot_sample, data = biotime_traits, n = n) %>%
  replace(is.na(.), 0)
...
test <- get_plot_FD(biotime_traits, 17:64, sample_occurrence, 5617)
```
