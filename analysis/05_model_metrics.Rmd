...
get_model <- function(metric_name, formula, model_id, data, filter_study_id, bobyqa = FALSE, ...){
  ...
  if (missing(filter_study_id)){
    ...
    print(paste("Filter study", filter_study))
...
# 
# pmap_df(tofit_mods %>% select(metric_name = metric, filter_study_id = study_id), function(metric_name, filter_study_id) {model_data %>% 
