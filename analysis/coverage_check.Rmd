...
```{r}
get_coverage <- function(taxa, trait_data){
  taxa_data <- biotime_data %>%
...
get_coverage("Birds", elton_bird) %>% View()
get_coverage("Mammals", elton_mamm) %>% View()
get_coverage("Amphibians", amphibio) %>% View()
```
