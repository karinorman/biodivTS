...
check if all bird & mammal biotime data w/id's has an elton match. There are 81 species without a match (67 are birds).
```{r}
...
and 552 species without an ID, some of which are species codes
```{r}
biotime_data %>%
  #filter(taxa == "Birds") %>%
