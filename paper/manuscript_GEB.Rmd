---
title: Evaluating the evidence of widespread maintenance of functional composition in bird and mammal communities
# authors: 
...
Debate over the meaing of general trends, their robustness, and relevance for conservation action is ongoing.
...
While functional loss is frequently cited as one of the most pressing concerns of the anthropocene [@cardinale2012; @dirzo2014; @young2016], local-scale loss is not necessarily inevitable even in scenarios of species loss [@daz2001; @petchey2009]. Forecasts of functional loss range from negligible [@gallagher2013] to dire [@petchey2002; @pimiento2020]. And while some observed trends show significant functional loss [@flynn2009] others document no loss even in some of the most heavily impacted communities [@edwards2013; @matuoka2020]. On paleoecological time scales functional composition shows mixed responses to environmental change and extinction events [@jackson2015; @dornelas2018], with significant impacts of species extinctions on functional diversity in some taxa and not others [@pimiento2017]. Some losses of functional diversity are indisputable on both paleocological and contemporary timescales such as continued trophic downgrading <!-- or is it just body-size downgrading? we lost mega grazers too --> due to loss of large-bodied mammals, but implications of those losses for local diversity patterns are less clear [@estes2011; @smith2018] .
...
We did not impose a correction for unobserved species as non-parametric estimators do not assign species identities to corrected richness values, and therefore could not be propogated to the functional diversity metrics.
...
We discuss here the possible ecological processes underpinning maintenance of functional diversity, particularly in a global change context.
...
First, functional redundancy in the species pool maintains resilience of the functional space by providing multiple potential species for a any given set of functional traits.
Alternatively, while there may be low redundancy in the functional space, functional composition in the species pool may be replenished by changes in the composition of the species pool to to shifts in species ranges.
<!-- what does global change say about trajectory of functional redundancy -->

-   what is the expectation for change in functional redundancy (and species pool changes) due to global change?

-   don't have the data here to directly assess temporal shifts in the species pool per say, so we can't distinguish between these process, buy you could do it x,y,z way

-   paleoecological studies indicate that functional composition can be largely conserved for long periods of time (strong ecological process), and losses are only seen after catastrophic events (e.g. terminal pleistocene extinction).

-   discuss possibility of a tipping point?
    catastrophic loss following long period of stability, what might the early warning signs be of that?

<!-- change this discussion to reconciling with other long term trends and where the differences may arise -->
...
<!-- in the communities we sampled we trophic downgrading has probably already occurred! -->

-   discussion of expectations for undersampled areas (Africa particularly that still has a lot of its megafauna)?
