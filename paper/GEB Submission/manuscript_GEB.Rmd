...
Study-level slopes for functional diversity metrics were significantly related to start year of the time series for Jaccard similarity and functional evenness, both of which had significantly more negative slopes with more recent start year.
No functional diversity metrics were significantly related to the start year of the time series.
...
Despite a lack of general trends in functional diversity metrics, we did find evidence of compositional shifts in the trait space with multiple `significant` trends in *CWM*'s for studies coming from the same taxa, realms, or climates, `indicating areas of consensus change across communities`.
...
Given the studies in this group come from all possible taxa, realms, climates, and protection statuses this option is a strong possibility and offers some hope that there are areas of the globe where communities are fairing well for now.
...
Three of the groups fit under the broad umbrella of changes in redundancy, including communities exhibiting gains or losses in species richness with no change in functional metrics or turnover and richness loss with significant turnover.
These communities experience changes in species richness that do not impact the overall functional space, meaning species gains or losses represent a loss or increase in functional redundancy respectively.
Where turnover is also occurring, species are being exchanged for functional analogs from the species pool.
For communities exhibiting loss of redundancy, ecological processes are likely being maintained, but have a reduced capacity to respond to future stressors.
These communities are actually fairing better than expected looking at species-based metrics alone, but are also in a precarious position for maintaining ecological function into the future.
Conversely, communities exhibiting a increase in redundancy (via an increase in species richness) are becoming better positioned to respond to future stressors, but are not actually expanding their functional capacity as may be assumed by looking at species gains alone.

-   add redundancy literature context?
...
Notably, the studies that exhibited species richness increases (in this group with increasing functional richness, as well as communities without functional richness increases) were exclusively from terrestrial, temperate (sometimes temperate/polar) bird communities.
We therefore have a strong indication that communities whose functional state has improved may be restricted to these specific contexts for x,y,z reasons.

The final group exhibits decreasing functional evenness.
The implications of this change current and future maintenance of functional structure is the least clear from our current understanding of the relationship between different aspects of functional diversity and ecological process.
Maintaining evenness may be important for supporting multifunctionality in communities [@bagousse-pinguet2019]
...
While we have an indication of the ecological characteristics most likely to lead to some of the change types (e.g. temperate bird communities are gaining species and functional richness), most types of change are exhibited across many different kinds of communities.
Identifying key factors mediating the kind of biodiversity change a community experiences is critical for identifying areas of conservation concern and extrapolating our results to areas where functional trait data may not be available.
While it is tempting to draw a one to one line between the degree of human impact and loss functional integrity (in the form of functional redundancy and richness), that relationship is not borne out by our rough metric of human impact or previous taxa or single community work.
...
Where turnover is occurring, it is almost always accompanied by a `r colorize("trend in one of the functional diversity metrics, indicating", "blue")` directional change in the functional space.
Species are not therefore being replaced by exact functional counter parts.
The fact that we observed both increases and decreases in corrected functional richness accompanying turnover is a reminder that `r colorize("new species are not always replacing more functionally unique species, but are often more functionally unique themselves.", "blue")` <!-- While shifts in functional space may be the result of environmental pressure, we cannot distinguish between directional change and shifts due to the inavailability of an analog species in the species pool. Comment: Want to say that trends could be an indication of adaptation to changing environment OR the result of extirpations being replaced (or not) by non-analoge species. Can't really distinguish between those things. -->
