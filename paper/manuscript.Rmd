...
read_csv(here::here("figures/man_model_table.csv")) %>%
  ...
  mutate(metric = ifelse(metric == "Jaccard_base", "Jaccard", metric),
         ...
         group = case_when(
           group == "rarefyID:study_id" ~ "timeseries within study",
