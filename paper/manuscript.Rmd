...
Impacts of these pressures are well documented at a global scale by an accelerating global extinction rate [@barnosky2011], and fundamental changes in some of the most well-studied systems [e.g.
coral bleaching; @sully2019].
...
To assess functional change independent of species richness we calculating the standardized effect size (SES) for each metric from null estimates [@swenson2012].
...
We also need theory that links ecological process to the kinds of changes actually happening in communities.
Do the shifts we see matter?
Are there shifts we didn't even measure that are critical for function and resilience?
