...
The vast majority of experimental and observational work links function to changes in functional or species diversity.
By those criteria, very few observed communities in our dataset are in a state of concern for declining functionality.
However, we did not we did not directly measure some aspects of community structure important for ecosystem multifunctionality [e.g. dispersion, rarity, abundance of dominant species; @bagousse-pinguet2021].
While our metrics indirectly incorporate dimensions of the functional space related to those characteristics, they are likely not sensitive enough to infer deterioration (or improvement) in those those aspects of structure.

<!-- has important implications for biodiversity and ecosystem function (BEF). BEF work links ecosystem function to changes in species and functional diversity, however very few observed communities experienced changes along either of those characteristics. Do we then not need to worry about loss of function in most bird, mammal and amphibian communities? While -->

<!-- Always the option that we didn't measure traits related to function, though in this case I think we did. We did not however measure fucntional redundancy, which could be important for maintaining multifunctionality [@bagousse-pinguet2019] . Also may not be sensitive enough to detect significant decreases in abundance for the most dominant species, which may also be important-->

<!-- meet the criteria for biodiversity loss as defined in BEF work (loss of species or loss of functional diversity) and the communities that lost species maintained functional diversity. Need to measure the right traits, but also decide what kind of shifts are important for functional change. But this is also good news! Most communities appear to be just fine from a function standpoint following best practices. -->
...
<!-- how does this reconcile with the large body of studies showing that extinctions primarily affect functionally rare species? It seems inconsistent with their findings -->

Maintenance of functional composition contradicts likely scenarios of loss predicted due to rare species extinction.
...
Assuming local extirpation is a precursor to global extinction, communities losing functionally rare species should exhibit strong functional shifts as lost species cannot be replaced by functionally similar species [@leitão2016] .
