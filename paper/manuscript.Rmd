...
We found no significant overall trend in species richness or observed or null-corrected functional diversity metrics (Fig 2).
...
At the study level, 4 studies experienced a significance trend and only 10 of 54 studies for uncorrected metrics and 4 of 54 studies for corrected metrics experienced a significant trend for a metric other than Jaccard similarity (Table 2).
Trends for all but one study were inconsistent between corrected and uncorrected metrics, with significance for one or the other.
