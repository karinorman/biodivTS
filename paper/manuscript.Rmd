...
```{r metric-fi, fig.cap="Example distributions of species and abundance for a single trait axis for high and low values of our measured metrics.", echo=FALSE, strip.white=TRUE}
...
We assessed the impact of study-level characteristics on slope estimates...
