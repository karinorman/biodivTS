...
fundamental changes in some of the most well-known systems (e.g. coral
bleaching. At the local scale however the most common metric of
biodiversity, species richness, tells a different story. Recent
large-scale assessments of trends in biodiversity over time have shown a
decoupling of community composition from richness [@brose2016], evidence
of community-level regulation of richness [@gotelli2017], and no net
change in local biodiversity despite widespread environmental change
[@brown2001; @dornelas2014; @vellend2013;, @vellend2017] despite ongoing
species turnover. While communities are clearly changing, our most
common species-based approaches do not fully capture the nature of that
change.
...
independent of species change. The rich history of connecting functional
diversity to ecosystem function and resilience and community assembly
provide further context in which to interpret changes in functional
diversity.
<!-- turn that last sentence into its own paragraph? e.g. what functional diversity tells us about community structure and function -->
...
traits collected in situ. However, ongoing efforts to assemble
functional traits for a variety of taxa have made synthesis of existing
community assemblage data with functional traits possible for the first
time [@trindade-santos2020; @jarzyna2016; @barnagaud2017], providing
initial looks at how functional diversity changes on a broad-scale. We
approach local biodiversity change through this lens, providing the
first cross-taxa and cross-system assessment of functional diversity
change through time.
