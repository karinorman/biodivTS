...
The North American Breeding Survey for example is made up exclusively of roadside surveys and is therefore in relatively close proximity to human impact [@pardieck2020] .
It is considered an authoritative dataset on the state of bird populations on the continent and underpins policy decisions about bird conservation [@rosenberg2019; @sauer2017].
...
Local maintenance of functional structure has important implications for biodiversity and ecosystem function (BEF).
BEF work links ecosystem function to changes in species and functional diversity, however very few observed communities experienced changes along either of those characteristics.
Do we then not need to worry about loss of function in most bird, mammal and amphibian communities?
Always the option that we didn't measure traits related to function, though in this case I think we did.
We did not however measure fucntional redundancy, which could be important for maintaining multifunctionality [@bagousse-pinguet2019] .
Also may not be sensitive enough to detect significant decreases in abundance for the most dominant species, which may also be important

-   Traits are not grounded in theory, might be measuring the wrong ones

-   

Even if there were unobserved communities experiencing huge shifts,

meet the criteria for biodiversity loss as defined in BEF work (loss of species or loss of functional diversity) and the communities that lost species maintained functional diversity.
