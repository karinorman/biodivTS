...
On paleoecological time scales, functional composition is often conserved alongside species diversity even in the face of drastic environmental change [@jackson2015; @barnosky2005].
It is therefore critical to establish whether or not functional loss is the general rule for communities on time scales relevant for current environmental impacts.
...
<!-- While we did not explicitly assess how turnover rates compare to background turnover, --> <!-- language to distinguish between "functional traits" and a species' role in the context of the functional space -->
...
We may simply not have data from those areas experiencing the greatest functional shifts [hughes2021].
