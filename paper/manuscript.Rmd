...
We observed no significant trends within taxa No significant differences between taxa.
Indicates that we could've looked at any taxonomic subset of the data and gotten the same result.
But what does that mean for taxa we left out?
We can only make educated guesses based on what we know of the ecology of taxa that were left out - taxa specific papers?

What does local maintenance of functional structure mean for the function of these communities?
...
By those criteria, very few observed communities in our dataset are in a state of concern for loss of functionality.
However, we did not directly measure some aspects of community structure important for ecosystem multifunctionality [e.g.
dispersion, rarity, abundance of dominant species; @bagousse-pinguet2021].
While our metrics indirectly incorporate dimensions of the functional space related to those community characteristics, they are likely not sensitive enough to infer deterioration (or improvement).
<!-- more citations please --> This highlights the need for further development of theory linking different aspects of functional change to specific implications for function.

-   experiments vs broad scale observational studies - do we look at FD in both?

<!-- any work looking at function in communities that are stable along these axes? -->
...
Traits would be especially beneficial if they explicitly incorporate existing frameworks for linking traits to processes, including the now widely accepted response and effect framework [@lavorel2002].
