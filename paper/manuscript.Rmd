...
This striking result could be a product of two possible processes which we discuss futher here.
First, systemic maintenance of functional structure across communities, or second, a failure of existing data and methods to detect a true underlying change.
...
Why then do we find no change in functional diversity despite extensive predictions to the contrary from both theory and local studies?
...
Targeted collection of even species-traits we may think are especially impacted by environemental change and have particular relevance for function.
