...
<!-- Despite widespread concern about the loss of functional diversity, our analysis does not indicate significant change in functional composition is the rule for communities. Why -->

This study represents the best available data and biodiversity synthesis approaches.
Why then do we find no change in functional diversity despite extensive predictions to the contrary from both **theory** <!-- need more theory in the intro? --> and and many local studies?
First, the Biotime database is not a representative sample of the world's biodiversity or areas of greatest threat [@gonzalez2016; @vellend2017] (other sampling citation!), and the subset of data in this study exhibits a strong Northern Hemisphere bias. We may simply not have data from those areas experiencing the greatest functional shifts [hughes2021]. We do however emphasize that even disturbed communities maintain functional structure [@edwards2013; @matuoka2020], and the inclusion of more heavily impacted sites would not necessarily change the result.

\<!-
- You'd imagine the pattern would still be visible even with North American birds...

To further explore the issue we look for example at the North American Breeding Birdy Survey, included in this study and assessed in many other publications.
--\>
...
This is especially relevant in the context of biodiversity change as lost species could be replaced by a species with very different functional attributes, but the replacement would go undetected if the new species expanded the trait space by the same degree and had similar abundance.This may be particularly relevant for communities tracking shifting environmental conditions, as communities may maintain some characteristics of their functional composition while shifting to track the new conditions.
Metrics developed to assess shifts and overlaps in trait spaces are now being developed (citation), and further exploration of time series using those approaches may disentangle trait space characteristics from the location of the occupied space.
