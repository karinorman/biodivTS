...
The globe is in the midst of a biodiversity crisis due to anthropogenic impacts. It is critical to understand how ecological communities are changing in response xxx. Previous broad-scale assessments of biodiversity change through time have focused on metrics of species identity rather than the role species play in the community. Functional trait data offer a powerful opportunity to directly assess changes in community functional composition alongside species-based patterns. Here, we pair vertebrate community timeseries with functional trait data to take a first look at temporal trends in functional composition. We found no evidence of systematic functional loss across communities, with maintenance of all measured aspects 
