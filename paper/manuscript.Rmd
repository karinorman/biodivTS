...
To test for trends within taxa, biome, and realm, groups we also fit models with random slope and intercept effects for each one of these factors.
...
BLUP's provide an estimate for the conditional mean and variance of each level of a random effect.
from which we calculated 95% confidence intervals to determine significance of study-level slopes.
...
There was also no temporal trend in those metrics within taxa, biome or realm groups.
