...
Impacts of these pressures are well documented at a global scale by an accelerating global extinction rate [@barnosky2011], and fundamental changes in some of the most well-studied systems [e.g. coral bleaching; @sully2019]. At the local scale however, species diversity tells a different story. Recent syntheses of local trends in biodiversity over time have found no net change in local species diversity despite ongoing turnover [@brown2001; @dornelas2014; @vellend2013; @vellend2017] and evidence of a significant shifts in community composition underlying consistent species richness [@brose2016; @gotelli2017].
...
Functional diversity metrics are therefore uniquely suited for assessing community shifts underlying even constant species richness trends.
...
We focus on mammal, bird, and amphibian species as a significant subset of the world's biodiversity heavily impacted by anthropogenic change (citation).
...
In order to ensure comparability across taxa in trait type and data quality we therefore we focus on Anamalia here.

We assess thousands of mammal, bird, and amphibian functional diversity timeseries to determine whether or not there is a general trend of functional change.
...
<!-- We expect to find a general trend of functional loss underlying similar patterns of constant species richness and increasing turnover, as communities exhibit the impacts of accelerating environmental change. -->

<!-- While trait data exists for other taxa in the BioTIME database, we focus on these groups because they have accepted species-level means, comparable traits collected across taxa, and near comprehensive species coverage. Plants in particular have a rich history of functional trait work, but are far more specoise and suffer from biases in trait coverage that could have meaningful impacts on interpretation of trends [@fitzjohn2014]. -->

<!--These taxa represent a significant portion of the world's biodiversity and we have no prior expectation that the inclusion of additional taxa would significantly alter the picture of functional change. W and as such should capture general trends -->

<!--We have no prior expectation based on ecological theory that broad scale functional shifts would be significantly different between taxa, as communities of all different kinds of organisms are shaped by the same processes (citation). -->

\
<!--if the hypothesis of global biodiversity trends is true, there is no reason to believe that it would not be evident in animals alone, and only manifest when plants are included. Examining trends in functional traits of plants is certainly of equal interest, but raises additional challenges (species-level means, comparable traits cross-taxa, bias).  Therefore we focus on Anamalia here.-->

### Material and Methods

#### Data

We obtained mammal, bird, and amphibian timeseries from the BioTIME database, a global repository of high quality assemblage timeseries.
...
Non-significant overall trends are the result of both non-significant trends a the study level, and a balance of positive and negative trends.
...
Two studies experienced a significant decrease in functional evenness, and one study experienced a significant decrease in both functional richness and functional divergence (Table 2).
...
Null trends appear to give strong evidence of systemic maintenance of functional structure due to common ecological processes, however multiple limitations of current approaches in synthesis could potentially be obscuring a true underlying trend.
...
This suggests certain characteristics of the functional space are maintained even in the face of significant change in species identity, specifically the size of the functional space occupied by the community (FRic) and the distribution of species and individuals within that space (FEve and FDiv).
...
If this is true, it has significant implications for how we approach work on biodiversity and ecosystem function.
Very few observed communities meet the criteria for biodviersity loss as defined in BEF work (loss of species or loss of functional diversity) and the communities that lost species maintained functional diversity.
Need to measure the right traits, but also decide what kind of shifts are important for functional change.
But this is also good news!
Most communities appear to be just fine from a function standpoint following best practices.

No significant differences between taxa.
Indicates that we could've looked at any taonomic subset of the data and gotten the same result.
...
any differences in some of the taxonomic groups even if not significant?

do we expect different results for different taxa?

<!-- how does this reconcile with the large body of studies showing that extinctions primarily affect functionally rare species? It seems inconsistent with their findings --> Maintenance of functional composition contradicts likely scenarios of loss predicted due to rare species extinction.
Rare species, defined by small populations and geographic restriction, are simultaneously more likely to be functionally distinct and at higher risk for extinction [@davies2004; @harnik2012; @loiseau2020]. Assuming local extirpation is a precursor to global extinction, communities losing functionally rare species should exhibit strong functional shifts as lost species cannot be replaced by functionally similar species [@leitão2016] .
Instead, these communities appear to only have turnover of species with functionally redundant species in the species pool.
<!-- good news for ecosystem function! -->
