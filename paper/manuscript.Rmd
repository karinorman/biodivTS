...
<!-- While we did not explicitly assess how turnover rates compare to background turnover, --> Our results give strong evidence that maintenance of functional structure is not just a phenomena of paleoecological time scales but also happens on annual time scales [@barnosky2004; @jackson2015].
...
<!-- Widespread functional stability has important implications for how we approach the relationship between biodiversity and ecosystem function. Just as links between declining species diversity and function may be less relevant than we thought (citations!) so too the realtionship between functional diversity and ecosystem function.  his is good news for ecosystem function! But we may also be measuring the wrong dimensions of the trait space or the wrong traits. Can't really say BEF needs to measure function directly because these communities aren't losing species or functional diversity - turnover is either within regular bounds or if not (if more turnover than normal) it's still maintaining community structure. And presuming that the original structure was good for function, maintaining it is also good for function! -->
...
Why then do we find no change in functional diversity despite extensive predictions to the contrary from both **theory** <!-- need more theory in the intro? -->and many local studies?
